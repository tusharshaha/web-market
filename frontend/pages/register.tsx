  ...
  return (
    <div className="register flex items-start justify-center px-10">
      <div className="max-w-3xl">
        <button
          onClick={handleBack}
          className="btn glass btn-sm sm:btn-md flex items-center gap-1 text-white mb-5"
        >
          <span>
            <FaBackwardStep />
          </span>
          ...
          <div className="register_top">
            <div className="pt-14 text-white space-y-5 w-full px-6 md:px-0 md:w-2/3 mx-auto text-center">
              ...
              <p className="text-xs md:text-base">
                Discover endless opportunities in our vibrant community of
                developers, job seekers, and professionals. Join us to search
                for jobs, create profiles, upload resumes, showcase projects,
                and share your expertise through blogs. Let&apos;s shape your
                future together!
              </p>
            </div>
          </div>
          <div className="bg-white flex flex-col items-center justify-center px-4 py-8">
            ...
            <div className="w-full px-4 sm:px-0 sm:w-2/4 mx-auto">
              ...
              <button
                ...
                className="btn glass flex items-center btn-xs md:btn-md gap-3 text-slate-500 mx-auto"
              >
