...
const HowItWork: React.FC = () => {
  const works = [
    {
      icon: (
        <AiOutlineUser className="text-4xl text-primary group-hover:text-white" />
      ),
      title: "Create an Account",
    },
    {
      icon: (
        <CgNotes className="text-4xl text-primary group-hover:text-white" />
      ),
      title: "CV/Resume",
    },
    {
      icon: (
        <AiOutlineSearch className="text-4xl text-primary group-hover:text-white" />
      ),
      title: "Find Your Job",
    },
    {
      icon: <FiSend className="text-4xl text-primary group-hover:text-white" />,
      title: "Apply Job",
    },
  ];
  return (
