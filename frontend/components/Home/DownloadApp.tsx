  ...
  return (
    <div className="p-5 mt-14 mb-24 relative w-full bg-[url('/images/bg1.webp')] bg-cover py-28 text-center text-white font-bold">
      ...
      <div className="relative z-20">
        <h3 className="my-5 text-xl md:text-2xl">
          Trial Version Available from then
        </h3>
        <h3 className="text-3xl md:text-4xl my-3 ">Download Our Mobile App</h3>
