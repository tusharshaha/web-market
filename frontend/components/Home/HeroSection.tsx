...
const HeroSection = () => {
    const backgroundImageUrl =
        'https://htmldemo.net/finate/finate/assets/img/slider/slider-bg.webp';
                    ...
                    <div className='p-5 md:p-0'>
                        ...
                        <div className=' flex flex-col md:flex-row justify-between gap-2 items-center mt-10'>
                            <div className='flex gap-2 flex-col sm:flex-row w-full justify-between items-center'>
                                ...
                                <select className='w-full sm:w-[300px] md:w-[200px] p-5 bg-white rounded-lg  text-gray-700 outline-none border-gray-200'>
                            ...
                            <div className='flex gap-2 flex-col sm:flex-row w-full justify-between items-center'>
                                <select className='w-full sm:w-[300px] md:w-[200px] p-5 bg-white rounded-lg  text-gray-700 outline-none border-gray-200'>
                                    <option value="1" selected>Choose Ctegory</option>
                                ...
                                <button className='w-full flex justify-center items-center sm:w-[300px]  md:w-auto bg-primary p-5 text-white rounded-lg text-xl font-bold'><BiSearch className='font-bold'></BiSearch> </button>
